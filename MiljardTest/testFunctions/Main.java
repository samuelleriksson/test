...
public class Main {
    public static void main(String[] args) { // index 0 = vilken funktion som ska test, måste skickas,
        ...
        ArrayList<Integer> l = prep.readIntegersFromFile("MiljardTest/dataInAndOut/dataIn/RandomInts.txt");
        ...
        try {
            ...
            switch (x) {
                case 1 -> {
                    ...
                    prep.writeIntegersToFileAppended("MiljardTest/dataInAndOut/dataOut/javaIterationData.txt", r1);

                }

                case 2 -> {
                    long r2 = runTime.arithmetic(iterationNbr);
                    prep.writeIntegersToFileAppended("MiljardTest/dataInAndOut/dataOut/javaArithmeticData.txt", r2);

                }
                case 3 -> {
                    long r3 = runTime.timsort(l);
                    prep.writeIntegersToFileAppended("MiljardTest/dataInAndOut/dataOut/javaSortData.txt", r3);
                }
